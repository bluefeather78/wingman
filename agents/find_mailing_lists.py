...
USAGE:
    python -m agents.find_mailing_lists --preview --limit 10   # free: what would it touch
    python -m agents.find_mailing_lists --limit 10             # the pilot pass
    python -m agents.find_mailing_lists --all                  # every unchecked active row
    python -m agents.find_mailing_lists --ids ec17081,ab12cd3  # named rows, e.g. a re-check
"""
import argparse
import datetime
import json
...
from wingman.claude_common import call_claude, estimate_cost, extract_json
from wingman.mailing_list_common import candidate_urls, fetch_page, find_candidates
from wingman.supabase_common import load_dotenv, supabase_get, supabase_insert_one, supabase_patch, supabase_post

...
# Revokes a granted OAuth token (access or refresh). Used only by account deletion, to hand
# the Google grant back when a student erases their account (DATA_DELETION_EXPORT_PLAN.md §3.1).

...
def handle_mailing_list_status(request: Request, user: AuthedUser = Depends(get_optional_user)):
...
def handle_mailing_list_subscriptions(request: Request, user: AuthedUser = Depends(get_current_user)):

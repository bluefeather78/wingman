#!/usr/bin/env python3
"""Dry-run the page CLASSIFIER over the review queue. READ-ONLY (no writes).
...
Pilot with --limit first.
    ...
    python classify_queue.py                  # PAID full queue (~$1, ~25 min)
"""
import argparse
import datetime
import os
...
_SELECT = "id,name,org,url,type,is_active,moderation_status"
...
def main():
    ...
    print(f"\n[CLASSIFIER DRY-RUN] {len(queue)} rows, ~${total_cost:.4f}\n")

...
THREE PASSES, in order:
  ...
  1. python grade_mailing_lists.py --sample
  ...
  2. (approve, then) python find_mailing_lists.py --ids <the ids>

  3. python grade_mailing_lists.py --worksheet
  ...
  4. python grade_mailing_lists.py --score
...
def cmd_sample():
    ...
    print(f"  python find_mailing_lists.py --ids {ids}\n")
    print("Preview it for free first:\n")
    print(f"  python find_mailing_lists.py --preview --ids {ids}\n")
...
def cmd_worksheet():
    ...
    print("     Then: python grade_mailing_lists.py --score")
...
def cmd_verify(proposed):
    ...
    from supabase_common import load_dotenv as _ld
    _ld()

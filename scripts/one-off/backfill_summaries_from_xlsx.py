...
# Running it as `python scripts/one-off/backfill_summaries_from_xlsx.py` puts its OWN directory on sys.path, not the
...
XLSX_PATH = os.path.join(ROOT, "data", "Opportunities.xlsx")

...
for reading the outcome without opening the console.
    ...
    python send_lifecycle_emails.py --preview               # who is due (both kinds). Sends nothing.
    python send_lifecycle_emails.py --dry-run               # same, with the full detail list
    python send_lifecycle_emails.py --kind deadline --preview
    python send_lifecycle_emails.py                         # send (both kinds)

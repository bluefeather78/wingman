...
@pytest.fixture
def legal_footer():
    """The legal-entity line the email footer now carries in place of a postal address
    (operator directive, 2026-09-07). It is static — the entity name comes from legal/*.md via
    email_templates.LEGAL_ENTITY, not from an env var — so there is nothing to monkeypatch. The
    footer tests assert this string reached both the HTML and text footers."""
    from app.services import email_templates

    return email_templates.LEGAL_ENTITY

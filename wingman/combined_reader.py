...
scope here). `agents/refresh_opportunities.py` also stays standalone — kept as the lightweight
...
from agents import refresh_opportunities
...
def extract_metadata(url, page_text_str, call, name_hint="", org_hint=""):
    ...
    from wingman.gemini_common import estimate_cost, extract_json
